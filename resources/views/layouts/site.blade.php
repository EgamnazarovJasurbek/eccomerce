...
<head>
    ...
    <link rel="stylesheet" href="/allStyle/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="/allStyle/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="/allStyle/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="/allStyle/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="/allStyle/css/style.css" type="text/css">
</head>
...
<body>
    ...
    <!-- Humberger Begin For Mobile-->
    <div class="humberger__menu__overlay"></div>
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="/allStyle/img/logo.png" alt=""></a>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{ route('index') }}"><img src="/allStyle/img/logo.png" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="/allStyle/img/logo.png" alt=""></a>
                        </div>
                        <ul>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        ...
                        <div class="footer__copyright__payment"><img src="/allStyle/img/payment-item.png"
                                alt=""></div>
                    </div>
                </div>
            </div>
    ...
    <!-- Js Plugins -->
    <script src="/allStyle/js/jquery-3.3.1.min.js"></script>
    <script src="/allStyle/js/bootstrap.min.js"></script>
    <script src="/allStyle/js/jquery.nice-select.min.js"></script>
    <script src="/allStyle/js/jquery-ui.min.js"></script>
    <script src="/allStyle/js/jquery.slicknav.js"></script>
